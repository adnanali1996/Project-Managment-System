...
<form id="task_form" action="{{ route('subadmintask.store') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="project_id" id="project_id" class="selectpicker" data-style="btn-primary" style="width:100%;">
...
<script src="//cdn.tinymce.com/4/tinymce.min.js"></script>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            // THIS IS USED TO PICK THE DATE AND TIME
            jQuery(function() {
