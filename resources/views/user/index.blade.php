    ...
    <div class="modal-content">
        ...
        <form id="task_form" action="{{ route('user.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <!-- FOR THE ASSIGNMENT OF DEPARTMENT TO USER  -->
                <div class="col-md-5">
                    <div class="form-group">
                        <label>Department <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span></label>
                        <select name="depeartment" id="depeartment" class="form-control">
                ...
                <!-- END FOR THE ASSIGNMENT OF DEPARTMENT TO USER  -->
            </div>
